...
namespace IndoorMapTools.Model
{
    public partial class AnalysisResult : ObservableObject
    {
        ...
        public AnalysisResult(Building building, double reachableResolution, bool conservativeCellValidation,
            bool isClusterDirected, Action<int> progressCb = null)
        {
            ...
            Parallel.ForEach(building.Floors, curFloor =>
            {
                ...
                var ogmSegments = AnalysisModule.SegmentOGMtoImages(ogm, reachableScale);
                ...
                for(int i = 0; i < ogmSegments.Count; i++)
                {
                    ...
                    ogmInImages.Add(new Area(building.Floors.IndexOf(curFloor), i) { Reachable = ImageAlgorithms.BitmapImageFromBitmap(curSegment) });
                }
